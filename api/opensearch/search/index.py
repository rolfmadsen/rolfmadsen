...
def getsearchresult(search_query, objectFormat):
    ...
    # https://opensearch.addi.dk/test_5.2/?action=search&query=%22peter%22&agency=100200&profile=test&start=1&stepValue=10&outputType=json&objectFormat=marcxchange
